    ...
    <section cls="bg-white">
      <div cls="container px-5 py-8 md:py-16 mx-auto">
        ...
        <div cls="flex flex-col w-full space-x-0 space-y-6 lg:flex-row lg:max-w-screen-lg sm:mx-auto lg:space-y-0 lg:space-x-6">
          <div cls="flex flex-col w-full bg-white border border-gray-200 rounded-lg shadow-sm lg:w-1/2">
            <div cls="px-8 py-6 bg-gray-100">
              <h3 cls="text-center text-xl font-bold tracking-wider uppercase">
                Basic <span cls="font-light ml-2">Plan</span>
              </h3>
            </div>
            <div cls="px-8 flex-1 flex flex-col">
              <div cls="text-center py-4">
                <h3 cls="text-3xl font-bold md:text-4xl">Free</h3>
              </div>
              <div cls="flex flex-col justify-between space-y-6 flex-1 pb-6">
                <div>
                  <p cls="mb-4 font-bold tracking-wide">Features</p>
                  <ul cls="space-y-4">
                    <li cls="flex items-center">
                      <div cls="w-6 h-6 p-1 bg-green-200 rounded-full">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                          cls="w-full h-full text-green-800"
                        >
                          <path
                            strokeLinecap="round"
                      ...
                      <span cls="ml-3 text-lg text-gray-700">1GB of Space</span>
                    </li>
                    <li cls="flex items-center">
                      <div cls="w-6 h-6 p-1 bg-green-200 rounded-full">
                        <svg
                      ...
                      <span cls="ml-3 text-lg text-gray-700">
                        Unlimited Projects
                      </span>
                    </li>
                    <li cls="flex items-center">
          ...
          <div cls="flex flex-col w-full justify-between bg-white border border-gray-200 rounded-lg shadow-sm lg:w-1/2">
            <div cls="px-8 py-6 bg-gray-100">
              <h3 cls="text-center text-xl font-bold tracking-wider uppercase">
                Pro <span cls="font-light ml-2">Plan</span>
              </h3>
            </div>
            <div cls="px-8 flex-1 flex flex-col">
              <div cls="text-center py-4">
                <h3 cls="text-3xl font-bold md:text-4xl">
                  $69
                  <span cls="ml-1 text-xl font-normal text-gray-600">/mo</span>
                </h3>
              </div>
              <div cls="flex flex-col justify-between space-y-6 flex-1 pb-6">
                <div>
                  <p cls="mb-4 font-bold tracking-wide">Additional Features</p>
                  <ul cls="space-y-4">
                    <li cls="flex items-center">
                      <div cls="w-6 h-6 p-1 bg-green-200 rounded-full">
                        <svg
                    ...
                    <li cls="flex items-center">
                      ...
                      <span cls="ml-3 text-lg text-gray-700">And One More</span>
                    </li>
                  </ul>
                </div>
                <div>
